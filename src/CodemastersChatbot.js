    ...
    const createChatLi = (text, type) => {
      ...
      const handleCopy = (codeContent) => {
        ...
        navigator.clipboard.writeText(codeContent)
          .then(() => {
            console.log('Code copied to clipboard'); // Log success
          })
          .catch((error) => {
            console.error('Failed to copy code:', error); // Log any errors
          });
      };
...
export default CodemastersChatbot;
